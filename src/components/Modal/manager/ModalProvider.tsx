...
import { ModalType, UseModalManagerReturn, WineFormData, ReviewFormData, FilterState } from '../../../types/component-types';
          ...
          <WineFormModal
            ...
            onSuccess={(wine) => {
              ...
              if (modalData.onSuccess) {
                (modalData.onSuccess as (wine: Record<string, unknown>) => void)(wine);
              }
              // TODO: 성공 토스트 메시지 표시
        ...
        return (
          <ReviewFormModal
            ...
            onSuccess={(review) => {
              // 성공 콜백이 있으면 실행
              if (modalData.onSuccess) {
                (modalData.onSuccess as (review: Record<string, unknown>) => void)(review);
              }
              // TODO: 성공 토스트 메시지 표시
