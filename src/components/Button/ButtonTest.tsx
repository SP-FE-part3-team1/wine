...
const ButtonTest = () => {
  return (
    <div>
      <h1 style={{ margin: "20px 60px", fontWeight: "700" }}>!사용 예시!</h1>
      <div style={{ display: "flex", gap: "12px", margin: "10px 60px" }}>
        <Button
          variant="primary"
          radius={100}
          className={font["text-md-semibold"]}
          style={{ width: 279, height: 50 }}
        >
          와인 보러가기
        </Button>
      </div>
      ...
      <div style={{ display: "flex", gap: "12px", margin: "10px 60px" }}>
        ...
        <Button
          ...
          ariaLabel="닫기"
          radius={16}
          style={{ width: 60, height: 60, color: "#6a43db" }}
        >
          <svg
            width="20"
            height="20"
